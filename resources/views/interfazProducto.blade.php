...
<div class="py-4 flex flex-col md:flex-row bg-white dark:bg-card rounded-lg shadow-lg p-6 container">
  ...
  <div class="flex-1 md:pl-6">
    ...
    <div class="flex items-center mt-1">
      <button class="bg-secondary text-secondary-foreground rounded-l-md px-4">-</button>
      <input type="number" id="quantity" value="1" class="border border-border text-center w-16" />
      <button class="bg-secondary text-secondary-foreground rounded-r-md px-4">+</button>
    </div>
