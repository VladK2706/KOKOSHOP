                ...
                <form method="POST" action="{{ route('productos.update', $producto) }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="nombre" type="text" class="form-control @error('nombre') is-invalid @enderror"
                                name="nombre" value="{{ $producto->nombre }}" required autocomplete="nombre" autofocus>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="precio" type="number" class="form-control @error('precio') is-invalid @enderror"
                                name="precio" value="{{ $producto->precio }}" required autocomplete="nombre">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="tipo_producto" class="form-control @error('id_rol') is-invalid @enderror"
                                name="tipo_producto" value="{{ $producto->tipo_producto }}" required
                                autocomplete="tipo_producto">
                                <option value="{{ $producto->tipo_producto }}" selected>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="talla1" type="number" class="form-control @error('talla1') is-invalid @enderror"
                                name="talla1" value="{{ $producto->cantidadTalla->talla1 }}" required
                                autocomplete="nombre">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="talla2" type="number" class="form-control @error('talla2') is-invalid @enderror"
                                name="talla2" value="{{ $producto->cantidadTalla->talla2 }}" required
                                autocomplete="nombre">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="talla3" type="number" class="form-control @error('talla3') is-invalid @enderror"
                                name="talla3" value="{{ $producto->cantidadTalla->talla2 }}" required
                                autocomplete="nombre">
                    ...
                    <div class="row mb-3">
                        <label for="talla4" id="textTalla4" class="col-md-4 col-form-label text-md-end">
                            {{ __('Talla 4') }}</label>
                        <div class="col-md-6">
                            <input id="talla4" type="number"
                                class="form-control @error('talla4') is-invalid @enderror" name="talla4"
                                value="{{ $producto->cantidadTalla->talla4 }}" required autocomplete="nombre">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="talla5" type="number"
                                ...
                                value="{{ $producto->cantidadTalla->talla5 }}" required autocomplete="nombre">
